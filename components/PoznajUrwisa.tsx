...
export default function PoznajUrwisa() {
  ...
  return (
    ...
    >
      {/* --- PRZYWRÓCONE KOLOROWE TŁO (BLOBS) --- */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* PRAWA STRONA: Model 3D + PEŁNE ANIMACJE --- */}
          <div className="relative w-full h-[450px] lg:h-[750px] flex items-center justify-center">
            
            {/* 1. Orbitujące pierścienie (System wizualny Urwisa) */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              
              {/* Zewnętrzna orbita z ikonami */}
              <motion.div
                animate={{ rotate: 360 }}
              ...
              {/* Tło Glow (Pulsowanie kolorów marki) */}
              <motion.div
                animate={{ 
                  scale: [1, 1.15, 1],
                  opacity: [0.2, 0.4, 0.2]
