...
export default function HeroSection() {
  ...
  const address = "Sklep Urwis Władysława Reymonta 38A, Białobrzegi 26-800";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Twoje ulubione miejsce z <span className="font-bold" style={{ color: '#BF2024' }}>zabawkami</span> i <span className="font-bold" style={{ color: '#0055ff' }}>grami</span> w Białobrzegach
        </motion.p>
        ...
        >
          <div className="flex items-center gap-2 px-5 py-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg border border-gray-200">
            ...
            <div className="text-left">
              <div className="flex items-center gap-1">
                <span style={{ color: '#BF2024' }}>4.9</span>
          ...
          <motion.div 
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-5 py-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg border border-gray-200 cursor-pointer transition-all hover:shadow-xl"
          >
            <span className="text-2xl">🗺️</span>
            <div className="text-left">
              <div className="text-gray-800">Lokalizacja</div>
            </div>
          </motion.div>
      ...
      <Modal
        ...
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl p-6 max-w-4xl w-full mx-4 shadow-2xl outline-none"
